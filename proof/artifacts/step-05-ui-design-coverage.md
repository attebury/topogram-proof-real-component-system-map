...
| widget_command_toolbar | web | narrow | compact | acme.actionToolbar | rendered | compact, actionable | (none) | loading | review_required |
...
| design_missing_i18n | widget_command_toolbar | web | acme.actionToolbar | Widget 'widget_command_toolbar' has no authored message key. |
| design_missing_state | widget_command_toolbar | web | acme.actionToolbar | Realization 'command_toolbar_web_narrow' does not declare 'empty' state coverage. |
| design_missing_state | widget_command_toolbar | web | acme.actionToolbar | Realization 'command_toolbar_web_narrow' does not declare 'error' state coverage. |
